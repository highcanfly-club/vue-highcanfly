          ...
          >
            ...
            <div class="text-right">
              <span class="text-sm text-slate-400 mr-2"
                ...
                <a href="https://www.cloudflare.com"><i style="color:#E7873B" class="fab fa-cloudflare"></i> Cloudflare™</a>,
                ...
                Sanity.io</a> et propulsé par
                <a href="https://v3.vuejs.org/"
                  ><i style="color:#64B587" class="fab fa-vuejs"></i> Vue.js {{ app.version }}</a
                ></span
              >
            </div>
          </div>
