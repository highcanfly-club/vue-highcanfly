...
export function initAuth0({
    ...
    void (async () => {
        ...
        state.auth0Client = await createAuth0Client(Object.assign(Object.assign({}, options), { client_id: options.client_id, redirect_uri: redirectUri }));
        try {
    ...
    const getTokenSilently = (options = {}) => {
        return state.auth0Client.getTokenSilently(Object.assign(Object.assign({}, options), { detailedResponse: false }));
    };
    /** Fetches a new access token and returns the response from the /oauth/token endpoint, omitting the refresh token */
    const getTokenSilentlyVerbose = (options = {}) => {
        return state.auth0Client.getTokenSilently(Object.assign(Object.assign({}, options), { detailedResponse: true }));
    };
    ...
    const getUser = (options) => {
        return state.auth0Client.getUser(options);
    };
