<template>
  <nav
    id="top-nav" class="top-0 absolute z-40 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg"
  >
    <div
    ...
    >
      ...
      <div
        class="lg:flex lg:items-center lg:bg-opacity-0 lg:shadow-none"
        :class="[
          navbarOpen
        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            ...
            >
              <i
                :class="iconscolor"
                class="fab fa-instagram text-lg leading-lg"
              />
              <span :class="color" class="lg:hidden inline-block ml-2"
                >instagram</span
              >
            </a>
          </li>
          ...
          <li class="flex items-center">
            ...
            >
              <i
                :class="iconscolor"
                class="fab fa-twitter text-lg leading-lg"
              />
